...
We will use our best efforts to resolve any potential disputes through informal, good faith negotiations. If a potential dispute arises, you must contact us by sending an email to cavernprotocol@gmail.com so that we can attempt to resolve it without resorting to formal dispute resolution. If we aren’t able to reach an informal resolution within sixty days of your email, then you and we both agree to resolve the potential dispute according to the process set forth below.
...
As stated in Section 14, Assumption of Risk, we do not have custody of or access to users' digital assets or funds. As a result, please be very careful when using the protocol, as there is no way for us to assist you with canceling or otherwise modifying any transaction or transaction details. If you are having an issue or have a technical question regarding the protocol, you can seek the assistance of community contributors by opening a support ticket and describing your issue on the discord channel linked here <https://discord.gg/Bzau2dW9fu>.
