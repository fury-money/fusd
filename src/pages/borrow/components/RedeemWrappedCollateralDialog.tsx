...
function RedeemWrappedCollateralDialogBase(props: RedeemCollateralDialogProps) {
  const {
    className,
    closeDialog,
    collateral,
...
export const RedeemWrappedCollateralDialog = styled(RedeemWrappedCollateralDialogBase)`
  width: 720px;
  touch-action: none;
