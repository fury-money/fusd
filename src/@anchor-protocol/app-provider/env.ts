export enum ANCHOR_TX_KEY {
  ...
  BORROW_REPAY = "ANCHOR_TX_BORROW_REPAY",
  BORROW_PROVIDE_COLLATERAL = "ANCHOR_TX_BORROW_PROVIDE",
  BORROW_REDEEM_COLLATERAL = "ANCHOR_TX_BORROW_REDEEM",
  ...
  LIQUIDATION_WITHDRAW = "ANCHOR_LIQUIDATION_WITHDRAW",
  LIQUIDATION_WITHDRAW_COLLATERAL = "LIQUIDATION_WITHDRAW_COLLATERAL",
  LIQUIDATION_DEPOSIT = "LIQUIDATION_DEPOSIT",
}
...
export enum ANCHOR_QUERY_KEY {
  ...
  MULTIPLE_BORROW_BORROWER = "ANCHOR_QUERY_MULTIPLE_BORROW_BORROWER",
  ...
  BID_POOLS_BY_COLLATERAL = "BID_POOLS_BY_COLLATERAL",
  BID_POOLS_BY_USER = "BID_POOLS_BY_USER",

  TOTAL_LOCKED_COLLATERALS = "TOTAL_LOCKED_COLLATERALS",
  LIQUIDATION_HISTORY = "LIQUIDATION_HISTORY",
  LIQUIDATION_QUEUE_HISTORY = "LIQUIDATION_QUEUE_HISTORY",
  MONITOR_POSITIONS = "MONITOR_POSITIONS",

  NAME_SERVICE_REGISTERED_DOMAINS = "NAME_SERVICE_REGISTERED_DOMAINS",
  NAME_SERVICE_REGISTERED_DOMAIN_INFO = "NAME_SERVICE_REGISTERED_DOMAIN_INFO",

  WHITEPAPER_QUERY = "WHITEPAPER_QUERY",

  WRAPPED_TOKEN_HUB = "WRAPPED_TOKEN_HUB",
  LSD_TO_UNDERLYING_EXCHANGE_RATE = "LSD_TO_UNDERLYING_EXCHANGE_RATE",

  TFM_AVAILABLE_TOKENS = "TFM_AVAILABLE_TOKENS",
}
