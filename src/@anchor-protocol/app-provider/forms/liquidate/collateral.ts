...
function useTxFee(
  tokenAddress: CW20Addr | undefined,
...
export function useLiquidationWithdrawCollateralForm(
  collateral: WhitelistCollateral | undefined
): LiquidationWithdrawCollateralFormReturn {
  ...
  const { txFee } = useTxFee(
    ...
    collateral && "info" in collateral ? collateral.collateral_token : undefined
  );
